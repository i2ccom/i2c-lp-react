...
const serviceDetails: Record<string, ServiceDetail> = {
  ...
  fluid: {
    slug: "fluid",
    valueProp: "Next-Generation Repository & Resource Substrate for AI-First Software Work.",
    layer: 6,
    layerName: "Persistence Core",
    ...
    solution: "Fluid is a next-generation repository and resource substrate for AI-first software work. It keeps a Git-compatible mode for ordinary repositories while growing toward Fluid-native particles, graph-shaped history, structured binary deltas, S3-compatible object storage, and server-backed collaboration.",
    solutionHighlights: [
